...
if c=='Welcome':
    ...
    st.write('The convolutional neural network used, consists of 3 convolutional layers and a fully connected dense layer.')
elif c=='Description':
    ...
    st.write("The model can be tested by uploading an image corresponding to any gesture. The prediction will be displayed instantly.")
elif c=='App':
    st.title('Welcome to the working model.')
    up_file=st.file_uploader("Please upload your input image",type=['jpg','png'])

    #define a function for taking inputs and printing the outputs
